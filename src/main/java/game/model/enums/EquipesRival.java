...
public enum EquipesRival {
    RIVAL_0_1(0,1,Arrays.asList(new AbstractMap.SimpleEntry<>(4, 5))),
    RIVAL_0_4(0,4,Arrays.asList(new AbstractMap.SimpleEntry<>(7, 5))),
    RIVAL_0_7(0,7,Arrays.asList(new AbstractMap.SimpleEntry<>(1, 5))),
